...
import { selectTransactionFootprints, selectTransactions } from '../features/carbon-footprint-tracker/src/CarbonFootprintTrackerSelectors';
  ...
  render() {
    return (
      <View style={styles.container}>
        ...
        <Text style={{ fontSize: 32, textAlign: 'left', marginLeft: 18, marginTop: 16, marginBottom: 16 }}>1000kg of CO2</Text>
        <ScrollView>
